...
var DataService = /** @class */ (function () {
     ...
     * Load all speeches
     */
    DataService.prototype.loadSpeeches = function () {
...
var SpeechesStore = /** @class */ (function () {
    function SpeechesStore(dataService, toastr) {
     ...
     * Adds new speech
     */
    SpeechesStore.prototype.addSpeech = function (speech) {
        var speeches = this.subject.getValue();
     ...
     * Deletes a speech
     */
    SpeechesStore.prototype.deleteSpeech = function (speechId) {
        var speeches = this.subject.getValue();
        var newSpeeches = speeches.filter(function (speech) { return speech.id !== speechId; });
     ...
     * Load all speeches
     */
    SpeechesStore.prototype.loadSpeeches = function () {
        var _this = this;
        this.dataService.loadSpeeches().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (speeches) { return _this.subject.next(speeches); })).subscribe();
    };
    /**
     * Get all speeches
     */
    SpeechesStore.prototype.getSpeeches = function () {
     ...
     * Update speech
     */
    SpeechesStore.prototype.saveSpeech = function (speechId, changes) {
        var speeches = this.subject.getValue();
        var speechIndex = speeches.findIndex(function (post) { return post.id === speechId; });
        var newCourse = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, speeches[speechIndex], changes);
        var newCourses = speeches.slice(0);
        newCourses[speechIndex] = newCourse;
        this.subject.next(newCourses);
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(speeches[speechIndex]);
    };
    SpeechesStore.ctorParameters = function () { return [
...
var ShareSpeechComponent = /** @class */ (function () {
    function ShareSpeechComponent(bsModalRef, speechesStore) {
        this.bsModalRef = bsModalRef;
        this.speechesStore = speechesStore;
        this.event = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    ShareSpeechComponent.prototype.ngOnInit = function () {
        this.initializeSpeechForm();
    };
    /**
     * Initialize email form
     */
    ShareSpeechComponent.prototype.initializeSpeechForm = function () {
     ...
     * Save email share
     */
    ShareSpeechComponent.prototype.onSubmit = function () {
        var _this = this;
        var email = this.emailForm.value.email;
        this.speech.emailAddress.push(email);
        this.speechesStore.saveSpeech(this.speech.id, this.speech).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (res) {
            _this.event.emit(email);
            _this.bsModalRef.hide();
        })).subscribe();
    };
    ShareSpeechComponent.ctorParameters = function () { return [
...
var SpeechMainComponent = /** @class */ (function () {
    function SpeechMainComponent(modalService, speechesStore, toastr) {
        this.modalService = modalService;
        this.speechesStore = speechesStore;
        this.toastr = toastr;
    }
    SpeechMainComponent.prototype.ngOnInit = function () {
        this.initializeSpeechForm();
    };
    SpeechMainComponent.prototype.ngOnChanges = function () {
        if (this.speech) {
     ...
     */
    SpeechMainComponent.prototype.initializeSpeechForm = function () {
     ...
     * Deletes a speech
     */
    SpeechMainComponent.prototype.onDelete = function () {
        var _this = this;
        var speech = this.speechForm.value;
        this.speechesStore.deleteSpeech(speech.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (res) {
            _this.speechForm.reset();
            _this.speechForm.disable();
            _this.toastr.warning('Speech deleted!', 'Speech App');
        })).subscribe();
    };
    /**
     * Update speech
     */
    SpeechMainComponent.prototype.onSubmit = function () {
        var _this = this;
        var speech = this.speechForm.value;
        speech.keywords = this.speech.keywords;
        this.isProcessingRequest = true;
        this.speechesStore.saveSpeech(speech.id, speech).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (res) {
            _this.isProcessingRequest = false;
            _this.toastr.success('Speech updated!', 'Speech App');
        })).subscribe();
    };
    /**
     * Open share speech modal
     */
    SpeechMainComponent.prototype.openModal = function () {
        var _this = this;
        var initialState = {
            speech: this.speechForm.value
        };
        this.modalRef = this.modalService.show(_share_speech_share_speech_component__WEBPACK_IMPORTED_MODULE_6__["ShareSpeechComponent"], { initialState: initialState });
        this.modalRef.content.event.subscribe(function (email) {
            _this.toastr.success("Speech shared to " + email + ".", 'Speech App');
        });
    };
    SpeechMainComponent.ctorParameters = function () { return [
...
var SpeechSidebarComponent = /** @class */ (function () {
    function SpeechSidebarComponent() {
        this.speeches = [];
        this.speechChanged = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    SpeechSidebarComponent.prototype.ngOnInit = function () {
    };
    /**
     * Set selected speech
     */
    SpeechSidebarComponent.prototype.onSelect = function (speech) {
...
var AddComponent = /** @class */ (function () {
    function AddComponent(speechesStore, toastr) {
        this.speechesStore = speechesStore;
        this.toastr = toastr;
    }
     ...
     */
    AddComponent.prototype.initializeForm = function () {
        this.speechForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
     ...
     * Clear speech form
     */
    AddComponent.prototype.onClear = function () {
    ...
    AddComponent.prototype.onSubmit = function () {
        ...
        var speech = this.speechForm.value;
        this.isProcessingRequest = true;
        this.speechesStore.addSpeech(speech).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (speech) {
            _this.isProcessingRequest = false;
            _this.toastr.success("Speech by " + speech.author + " is added!", 'Speech App');
            _this.speechForm.reset();
        })).subscribe();
    };
...
var SearchComponent = /** @class */ (function () {
    function SearchComponent(speechesStore) {
        this.speechesStore = speechesStore;
     ...
     * Initialize forms
     */
    SearchComponent.prototype.initializeForms = function () {
     ...
     * Set form values
     */
    SearchComponent.prototype.onSelect = function (speech) {
     ...
     * Set search category
     */
    SearchComponent.prototype.setSearchCategory = function (category) {
        switch (category) {
            case '1':
                this.category = 'author';
                break;
     ...
     */
    SearchComponent.prototype.typeaheadNoResults = function (event) {
        this.noResult = event;
    };
...
var SpeechesRoutingModule = /** @class */ (function () {
    function SpeechesRoutingModule() {
    }
...
var SpeechesComponent = /** @class */ (function () {
    function SpeechesComponent(router, speechesStore) {
        this.router = router;
        this.speechesStore = speechesStore;
    }
    SpeechesComponent.prototype.ngOnInit = function () {
        this.speeches$ = this.speechesStore.getSpeeches();
    };
    /**
     * Set selected speech
     */
    SpeechesComponent.prototype.onSelect = function (speech) {
        this.selectedSpeech = speech;
    };
    SpeechesComponent.ctorParameters = function () { return [
